  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved itempedido as @itempedido" do
        ...
        post :create, {:itempedido => { "quantidade" => "invalid value" }}, valid_session
        assigns(:itempedido).should be_a_new(Itempedido)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested itempedido" do
        ...
        Itempedido.any_instance.should_receive(:update_attributes).with({ "quantidade" => "1" })
        put :update, {:id => itempedido.to_param, :itempedido => { "quantidade" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the itempedido as @itempedido" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Itempedido.any_instance.stub(:save).and_return(false)
        put :update, {:id => itempedido.to_param, :itempedido => { "quantidade" => "invalid value" }}, valid_session
        assigns(:itempedido).should eq(itempedido)
      end
